...
use crate::platform::input::Contact;
use crate::platform::window::ensure_foreground_and_topmost;

pub(in crate::platform) struct SeizeInputState {
    hwnd: HWND,
    block_input: bool,
...
impl SeizeInputState {
    ...
    pub(in crate::platform) fn touch_down(
        &mut self,
        contact: Contact,
        x: i32,
        y: i32,
    ...
    pub(in crate::platform) fn touch_move(
        &mut self,
        _contact: Contact,
        x: i32,
        y: i32,
    ...
    pub(in crate::platform) fn key_down(&self, key: i32) -> Result<()> {
        self.ensure_foreground()?;
    ...
    pub(in crate::platform) fn key_up(&self, key: i32) -> Result<()> {
        self.ensure_foreground()?;
    ...
    pub(in crate::platform) fn scroll(&self, dx: i32, dy: i32) -> Result<()> {
        self.ensure_foreground()?;
