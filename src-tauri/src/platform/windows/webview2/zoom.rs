...
/// 读取 WebView2 当前缩放因子。
pub(in crate::platform) fn get_zoom(window: tauri::WebviewWindow) -> Result<f64> {
...
/// 让设置页的缩放滑块与快捷键缩放保持同步。
pub(in crate::platform) fn register_zoom_changed_listener(window: &tauri::WebviewWindow) {
